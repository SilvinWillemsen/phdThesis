...
\section{String-plate connection}
...
\begin{align}\label{eq:connStringPlateFDSs}
    ...
    \!\!\!\dtt \wlmn &= -\kappa_\ptxt^2\dTwoD\dTwoD \wlmn - 2\szX[\ptxt]\dtd \wlmn + 2\soX[\ptxt] \dtm\dxx \wlmn + J_\ptxt(x_\ctxt, y_\ctxt)\frac{f^n}{ \rho_\ptxt H}\ ,
\end{align}

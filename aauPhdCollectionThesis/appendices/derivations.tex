...
\def\r{\text{r}}
\def\one{{(1)}}
This section provides a derivation for the update equation in Eq. \eqref{eq:pRadUpdate} and follows \cite[Sec. 4.1.3, pp. 109--111]. Recalling system \eqref{eq:barVPSystem}

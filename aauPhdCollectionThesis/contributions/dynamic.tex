...
in a one-step form (see Section \ref{sec:oneStepForm}}), 
...
\begin{figure}[h]
    ...
    \hfill
    \subfloat[Split is close to the boundary.]{\label{fig:quarticModesAddBoundary}{ \includegraphics[width=0.49\textwidth]{figures/contributions/dynamicgrid/interpolation/quartic1.eps}}}

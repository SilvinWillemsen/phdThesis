...
Small changes in parameters, both control and model parameters already yields a large behavioural change. As the focus of the work was not the friction model, the simpler, static friction was chosen instead. 

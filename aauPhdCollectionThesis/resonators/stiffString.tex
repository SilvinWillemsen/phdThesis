...
\end{align*}
As $\S$ is bounded by $1$ for all values of $\beta$, one can set $\S = 1$, and continuing with the substituted definitions for $\lambda$ and $\mu$ from Eq. \eqref{eq:stiffStringCourant} yields
\begin{align*}

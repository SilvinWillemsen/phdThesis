...
Although a collection of papers format has been used, the `extended summary' has been written in a monographic style. This thesis is divided into several parts which in their turn are divided in chapters. See Figure \ref{fig:thesisOutline} for a visual overview of the thesis structure. \SWcomment[WILL SAVE THIS SECTION FOR THE END] 

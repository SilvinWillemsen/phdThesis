...
\subsection{Continuous time\todo{FULL DOC SWEEP: check hyphen in titles (DOING)}}
...
The discrete raised cosine can be parametrised by its center location $l_0$ and width $w$ from which the start index $l_\text{s}$ and end index $l_\text{e}$ can be calculated, according to 
\begin{equation}

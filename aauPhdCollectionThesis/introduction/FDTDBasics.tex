...
A simple way to excite the system is to initialise the state using a raised cosine, or Hann window. More information on this will be given in Chapter \ref{ch:physInspExcitations}, but for completeness, the formula for a discrete raised cosine will be given here. \todo{$w$ does not have to be floored}

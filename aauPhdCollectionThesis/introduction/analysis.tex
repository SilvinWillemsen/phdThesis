...
\begin{subequations}
    ...
    \end{align}
\end{subequations}
The above identities will prove useful in energy analysis techniques later on. A derivation of \eqref{eq:summationByPartsMinusBar} is given below. 
...
\begin{equation}\label{eq:stabilityMK}
    k < 2\sqrt{\frac{M}{K}}.
\end{equation}
Recalling that $\omega_0 = \sqrt{K/M}$ (see Eq. \ref{eq:omega0MassSpring}), Eq \eqref{eq:stabilityMK} can be more compactly written as 
\begin{equation}
    k <\frac{2}{\omega_0}.
\end{equation}
...
\end{figure}\todo{ask stefania about these figure captions being identical}

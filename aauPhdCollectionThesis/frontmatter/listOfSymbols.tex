\chapter*{List of Symbols\markboth{List of Symbols}{List of Symbols}}\label{app:listOfSymbols}
The list of symbols found below contains often-used symbols in the thesis in the context that they are normally used.
...
\begin{longtable}{ p{2cm} p{6.5cm} p{2.5cm}  }
 ...
 $\alpha$ & Nonlinear collision term & - \\
